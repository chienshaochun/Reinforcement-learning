...
policy_net = DoubleDQN(state_dim, action_dim)
target_net = DoubleDQN(state_dim, action_dim)
...
for episode in range(cfg.episodes):
    ...
    for t in range(cfg.max_timesteps):
        ...
        if len(replay_buffer) >= cfg.batch_size:
            ...
            # Double DQN: action selection from policy_net, Q value from target_net
    ...
    print(f"DoubleDQN | Episode {episode}, Reward: {total_reward}, Epsilon: {epsilon:.2f}")
...
plt.savefig("rewards_double.png")
plt.show()
